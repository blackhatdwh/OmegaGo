...
# supervised training
def sup_train(processed_dir, read_file=None, save_file=None, epochs=10, logdir=None, checkpoint_freq=10000):
...
# reinforcement training of policy networks
def re_train_p(read_file=None):
    pass


# reinforcement training of value networks
def re_train_v():
    pass

parser = argparse.ArgumentParser()
argh.add_commands(parser, [gtp, preprocess, sup_train, re_train_p, re_train_v])
