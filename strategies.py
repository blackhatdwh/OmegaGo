...
class GtpInterface(object):
    def __init__(self):
        ...
        self.komi = 6.5
        self.clear()
        self.color = 1      # 1 for black, -1 for white
    ...
    def query_score(self):
        ...
        if self.color == 1 and result.startswith('B') or self.color == -1 and result.startswith('W'):
            return 1        # win
        elif self.color == 1 and result.startswith('W') or self.color == -1 and result.startswith('B'):
            return -1       # lose
        else:
            return 0        # draw
